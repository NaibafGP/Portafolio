import type { PersonalInfo, Project, Education, Experience} from "../types/portafolio";

export const personalInfo: PersonalInfo = {
    name: "Fabian Garcia",
    title: "Backend & Mobile Developer",
    summary: "Desarrollador de software enfocado en construir aplicaciones robustas, limpias y bien estructuradas. Cuento con experiencia en el backend con Java y Spring Boot (arquitectura en capas, APIs REST y control transaccional) y en mobile con Kotlin y Jetpack Compose. Actualmente estoy sumando React y TypeScript a mi stack, construyendo este mismo portafolio como parte de ese aprendizaje. Apasionado por las buenas prácticas y la resolución de problemas reales.",
...
export const projects: Project[] = [
    {
        id: "1",
        title: "Pvz Wiki",
        description: "App Móvil de la Wiki de Plantas vs Zombies, desarrollada con Kotlin y Jetpack Compose, utilizando una API REST creada desde cero para obtener la información de la base de datos en tiempo real.",
    ...
    },
    {
        ...
        description: "Simulación de una API REST para la gestión de una tienda, desarrollada con SpringBoot y JPA, se desarrolló desde cero la base de datos y se implementaron los endpoints para la gestión de productos, clientes y pedidos.",
